...
/**
 * Maps InvalidUndoTokenException to error response.
 */
#[AutoconfigureTag('app.exception_mapper')]
final class InvalidUndoTokenExceptionMapper implements ExceptionMapperInterface
{
    ...
    {
        return $exception instanceof InvalidUndoTokenException;
    }

    public function map(\Throwable $exception): ExceptionMapping
    {
        assert($exception instanceof InvalidUndoTokenException);
